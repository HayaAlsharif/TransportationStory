...
var dataset = [9, 6, 3, 4, 5, 6, 7, 8, 9, 10];
...
var indicators=['Price 21%', 'Number of Seats 17%', 'Mile per Galon 16%', 'Fun to Drive 13%', 'Make 11%', 'Saftey 8%', 'Speed 6%', 'Extras 4%','Automatic 3%', 'CO2 1%'];
var title=['What Car buyers car most about?']
